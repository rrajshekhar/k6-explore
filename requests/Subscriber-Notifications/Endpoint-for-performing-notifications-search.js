...
postman[Symbol.for("define")]({
  ...
  id: "61960489-2200-495e-a265-ca182dcc08ee",
  method: "GET",
  address: "{{baseUrl}}/notifications/subscriber/voluptate tempor proident",
  headers: {
  ...
  post(response) {
    // Validate status 2xx
    pm.test(
      "[GET]::/notifications/subscriber/:subscriberId - Status code is 2xx",
      function() {
    ...
    pm.test(
      "[GET]::/notifications/subscriber/:subscriberId - Content-Type is application/json",
      function() {
    ...
    pm.test(
      "[GET]::/notifications/subscriber/:subscriberId - Response has JSON Body",
      function() {
    ...
    pm.test(
      "[GET]::/notifications/subscriber/:subscriberId - Schema is valid",
      function() {
